...
## Project Structure
    ...
    ├── testloadapp_dev_22760  # Django project configurations
...
1. Clone this repo and `cd testloadapp_dev_22760`
...
2. Clone this repo and `cd testloadapp_dev_22760`
